            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset={1} stopColor="#22c55e" stopOpacity=".72" />
                </linearGradient>
              </defs>
            </svg>
      ...
      >
        ...
        <div className="fixed inset-0 z-[99999] flex px-4 py-6 sm:px-6">
          <div className="mx-auto flex h-full max-w-6xl items-center">
            <DialogPanel
              transition
              className="aspect-square max-h-full w-full overflow-hidden rounded-2xl bg-black shadow-2xl duration-300 ease-out data-[closed]:scale-95 data-[closed]:opacity-0"
            >
              <video
                ref={videoRef}
